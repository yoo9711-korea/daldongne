...
export default async function AdminLayout({
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', minHeight: 'calc(100vh - var(--header-h))' }}>
      <aside style={{
        ...
        <p style={{
          ...
          letterSpacing: '.1em', color: 'var(--wine)',
          marginBottom: 20,
        }}>ADMIN</p>
        ...
        <div style={{ marginTop: 32, paddingTop: 20, borderTop: '1px solid rgba(34,28,22,.1)' }}>
