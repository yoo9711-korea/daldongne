...
export default function BookProductionRequestButton({
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      alert(
        result.message ||
          '제작 신청이 접수되었습니다. 원고 검토 후 견적과 결제 방법을 안내해 드립니다.',
      );
...
function getDefaultMessage(
  ...
  if (hasRequest) {
    return '기존 제작 신청 내용을 수정하고 싶습니다.';
  }

  return '이 원고로 스토리북 제작을 신청하고 싶습니다.';
}
