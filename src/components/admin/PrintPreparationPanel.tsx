...
const styles = `
  ...
  .pp-heading{display:flex;justify-content:space-between;align-items:flex-end;gap:15px}.pp-heading p{margin:0;color:#c2644e;font-size:12px;font-weight:900;letter-spacing:.14em}.pp-heading h2{margin:6px 0 0}.pp-heading>strong{color:#806d64}
  ...
  .pp-quotes{margin-top:14px;display:grid;gap:9px}.pp-quotes article{padding:15px;border:1px solid #e8dad3;border-radius:13px;background:#fffdfa}.pp-quotes article[data-selected="true"]{background:#f1f9f3;border-color:#a9cfb6}.pp-quotes header{display:flex;justify-content:space-between;gap:15px}.pp-quotes header span{font-size:11px;color:#b45a45;font-weight:900}.pp-quotes h3{margin:4px 0}.pp-quotes p,.pp-quotes small{display:block;margin:8px 0 0;color:#806d64;line-height:1.6;font-size:12px}.pp-quotes em{display:block;margin-top:10px;color:#3f684e;font-style:normal;font-weight:800}
